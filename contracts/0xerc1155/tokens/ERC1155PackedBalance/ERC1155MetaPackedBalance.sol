...
contract ERC1155MetaPackedBalance is ERC1155PackedBalance, SignatureValidator {
  ...
  function metaSafeTransferFrom(
    ...
    require(
      _to != address(0),
      'ERC1155MetaPackedBalance#metaSafeTransferFrom: INVALID_RECIPIENT'
    );
  ...
  function metaSafeBatchTransferFrom(
    ...
    require(
      _to != address(0),
      'ERC1155MetaPackedBalance#metaSafeBatchTransferFrom: INVALID_RECIPIENT'
    );
  ...
  // );
  bytes32 internal constant META_TX_TYPEHASH =
    0xce0b514b3931bdbe4d5d44e4f035afe7113767b7db71949271f6a62d9c60f558;

  // keccak256(
  //   "metaSafeBatchTransferFrom(address,address,uint256[],uint256[],bool,bytes)"
  // );
  bytes32 internal constant META_BATCH_TX_TYPEHASH =
    0xa3d4926e8cf8fe8e020cd29f514c256bc2eec62aa2337e415f1a33a4828af5a0;

  // keccak256(
  //   "metaSetApprovalForAll(address,address,bool,bool,bytes)"
  // );
  bytes32 internal constant META_APPROVAL_TYPEHASH =
    0xf5d4c820494c8595de274c7ff619bead38aac4fbc3d143b5bf956aa4b84fa524;
  ...
  function _signatureValidation(
    ...
    bytes32 hash =
      hashEIP712Message(
        keccak256(abi.encodePacked(_encMembers, nonce, keccak256(signedData)))
      );
    ...
    require(
      isValidSignature(_signer, hash, fullData, sig),
      'ERC1155MetaPackedBalance#_signatureValidation: INVALID_SIGNATURE'
    );
    return signedData;
  }
