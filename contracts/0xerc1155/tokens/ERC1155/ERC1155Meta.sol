...
contract ERC1155Meta is ERC1155, SignatureValidator {
  ...
  function metaSafeTransferFrom(
    ...
    require(
      _to != address(0),
      'ERC1155Meta#metaSafeTransferFrom: INVALID_RECIPIENT'
    );
  ...
  function metaSafeBatchTransferFrom(
    ...
    require(
      _to != address(0),
      'ERC1155Meta#metaSafeBatchTransferFrom: INVALID_RECIPIENT'
    );
  ...
  function _signatureValidation(
    ...
    require(
      ...
      'ERC1155Meta#_signatureValidation: INVALID_SIGNATURE'
    );
    return signedData;
  }
