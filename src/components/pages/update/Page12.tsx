...
function Page12({ t }: PROPS) {
  ...
  const BlackBox = ({ boxTitle }: { boxTitle: string }) => (
    <Fragment>
      <div className="glide__slide">
        <div
          className={
            'glide__slide_custom_box d-flex justify-content-center font-10 font-weight-bold'
          }
        >
          {boxTitle}
        </div>
  ...
  return (
    <>
      <div className={'w-container bg-wolves text-white'}>
        <div className="">
          <div>
            <h2 className="tk-vincente-lightbold font-32 single-line">
        ...
        <div
          className={
            'd-flex flex-column bg-blue-transparent wolves-orange-border font-16 px-5 py-4 my-2 mt-3'
          }
        >
          {/* Card slider-1 */}
          ...
          >
            <button
              className={
                'w-100 m-0 mr-3 my-2 px-6 py-2 font-13 page5-btn-stack'
              }
            >
              MULTI TRANSFER
            </button>
                  ...
                  <div className="glide__track" data-glide-el="track">
                    <ul className="glide__slides">
                      {slider3Cards.map((card, i) => {
                        ...
                        return (
                          <SliderCardBox id={id} title={title} src={src} />
                        );
                      })}
                    </ul>
                  </div>
