    ...
    <>
      <div className={'w-container bg-wolves text-white'}>
            ...
            return (
              <div className="p-4 bg-blue-transparent " key={i + Math.random()}>
                <div className={"g-card"}>
                  <div className="p-1">
                    <div className="">
                      <h3 className={"tk-vincente-bold font-24"}> BOIS NYC USDT </h3>
                      <span className={"single-line"}> LPToken: 0.00 </span> <br/>
                      <span className={"single-line"}> Staked: 0.00 </span> <br/>
                      <span className={"single-line"}> Earned: 0.000000 WOWS, </span> <br/>
                    </div>
                  </div>
                  <div className="w-50 g-card-img-container">
                    <img className={"img-fluid g-card-big-small"} src={"https://4travelers.de/wolves_assets/cards/wolves/level2/GORGAN-300.mp4.jpg"} alt={"card img"}/>
                    <img className={"img-fluid g-card-img-small"} src={"https://4travelers.de/wolves_assets/cards/wolves/level2/GORGAN-300.mp4.jpg"} alt={"card img"}/>
                  </div>
                </div>
        ...
        <div style={{margin: '0 auto'}}>
          <Navigation
            centerLinks={[
              {href: 'temp?item=One', name: 'One'},
              {href: 'temp?item=Two', name: 'Two', active: true},
              {href: 'temp?item=Three', name: 'Three'},
            ]}
          />
        </div>

        <span className={"wolves-orange-light font-20"}> 1/20 RARITY - 25% PROFIT SHARE </span>
