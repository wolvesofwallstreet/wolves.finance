...
const Page9BoisBoardrooms = ({ t, location, history }: PROPS) => {
  ...
  return (
    <>
      ...
      <div className={'page9-container-fluid bg-flat2 text-white text-center'}>
        {/* Title & heading */}
        <div>
        ...
        <div className={'slider-wrap-bar bg-transparent-orange'}>
          <div className={'wrap'}>
            <div className="images glide glide-border-t glide-border-b">
        ...
        {/* Content */}
        <div
          className={'page9-two-column-container w-80 center-container my-5'}
        >
          {/* Left-side img */}
          ...
          <div className={'t-left px-lg-5'}>
            <h1 className={'tk-vincente h-1'}> YEARN QUAD POOL </h1>
            ...
            <div className={'d-flex '}>
              {/* left */}
              <div className={'w-100'}>
                <span className={'font-22 tk-vincente '}>GAS YOU SAVE</span>
